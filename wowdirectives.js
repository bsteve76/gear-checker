blizzApp.directive("showItem", function ($compile) {
    function getTemplate(slot) {
        var template = "<div style='color:white; padding:5px; margin-bottom:1px' ng-class='{\"uncommon\": item.quality == 2, \"rare\": item.quality == 3, \"epic\": item.quality == 4, \"legendary\": item.quality == 6}' ng-show='item.itemLevel > 0'>" +
